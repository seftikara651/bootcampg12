        ...
        return (
            <div className="animated fadeIn">
                {/* <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}> */}
                    ...
                    <CardBody>
                        <Form action="" method="post">
                            ...
                            <FormGroup row>
                                ...
                                <Col md="9">
                                    <FormGroup check inline>
                                        <Input className="form-check-input" type="radio" id="single" name="employeeMarital" value="Single" onChange={this.setMarriageStatus} />
                                        <Label className="form-check-label" check htmlFor="single">Single</Label>
                                    </FormGroup>
                                    <FormGroup check inline>
                                        <Input className="form-check-input" type="radio" id="married" name="employeeMarital" value="Married" onChange={this.setMarriageStatus} />
                  ...
                  <ModalFooter>
                    <Button color="primary" onClick={this.submitEmployee}>Edit</Button>{' '}
