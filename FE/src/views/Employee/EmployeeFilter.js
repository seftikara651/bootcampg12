...
class EmployeeFilter extends Component {
  ...
  // handleUserInput(filterNik) {
  //     this.setState({filterNik: filterNik});
  // }
    ...
    return (
      <div>
                      ...
                      <td>
                        <ButtonGroup>
                          <Button
                            ...
                            onClick={() =>
                              this.toggle(
                                employeeProfile.citIdNumber,
                                employeeProfile.nik,
                                employeeProfile.name,
                                employeeProfile.gender,
                                employeeProfile.birthDate,
                                employeeProfile.religionId,
                                employeeProfile.address,
                                employeeProfile.marriageStatus,
                                employeeProfile.childCount,
                                employeeProfile.positionId,
                                employeeProfile.levelId,
                                employeeProfile.placementId,
                                employeeProfile.beginContract,
                                employeeProfile.endContract,
                                employeeProfile.workPeriod
                              )
                            }
                          >
                            Edit
                          ...
                          <Button
                            ...
                            color="primary"
                            onClick={() =>
                              this.deleteEmployee(employeeProfile.nik)
                            }
                          >
                            Delete
                          </Button>
        ...
        <Modal
          ...
          toggle={() =>
            this.toggle(
              this.state.editCitIdNumber,
              this.state.editNik,
              this.state.editName,
              this.state.editGender,
              this.state.editBirthDate,
              this.state.editReligion,
              this.state.editAddress,
              this.state.editMarriageStatus,
              this.state.editChildCount,
              this.state.editPosition,
              this.state.editLevel,
              this.state.editPlacement,
              this.state.editBeginContract,
              this.state.editEndContract,
              this.state.editWorkPeriod
            )
          }
        ...
        >
                  ...
                  <Form action="" method="post">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        value={this.state.editCitIdNumber}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        name="editChildCount"
                        id="editChildCount"
                        placeholder="How many child do you have"
                        onChange={this.onChange}
                        value={this.state.editChildCount}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        type="date"
                        id="editBeginContract"
                        name="editBeginContract"
                        placeholder="beginContract"
                        onChange={this.onChange}
                        value={this.state.editBeginContract}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        type="date"
                        id="editEndContract"
                        name="editEndContract"
                        placeholder="endContract"
                        onChange={this.onChange}
                        value={this.state.editEndContract}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={this.onChange}
                        value={this.state.editWorkPeriod}
                      />
                    </FormGroup>
                  </Form>
                </CardBody>
          ...
          <ModalFooter>
            <Button
              color="primary"
              onClick={() => this.editEmployee(this.state.editNik)}
            >
              Edit
            </Button>{" "}
            <Button
