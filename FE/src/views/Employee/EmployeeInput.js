                    ...
                    <CardBody>
                        <Form action="" method="post">
                            <FormGroup>
                                ...
                                <Input type="text" id="citIdNumber" placeholder="Enter your citizen number" onChange={this.setCitIdNumber} value={this.state.citIdNumber} required/>
                            </FormGroup>

                            <FormGroup>
                                <Label htmlFor="nik">NIK</Label>
                                <Input type="text" id="nik" placeholder="Enter your nik" onChange={this.setNik} value={this.state.nik} required/>
                            </FormGroup>
                            ...
                            <FormGroup row>
                                ...
                                <Col md="5">
                                    <FormGroup check inline>
                                        <Input className="form-check-input" type="radio" id="male" name="gender" value="Male" onChange={this.setGender} />
                                        <Label className="form-check-label" check htmlFor="male">Male</Label>
                                    </FormGroup>
                                    <FormGroup check inline>
                                        <Input className="form-check-input" type="radio" id="female" name="gender" value="Female" onChange={this.setGender} />
                            ...
                            <FormGroup row>
                                ...
                                <Col md="9">
                                    ...
                                    {/* <FormGroup check inline>
                                        <Input className="form-check-input" type="radio" id="widow" name="employeeMarital" value="Widow" onChange={this.setMarriageStatus} />
